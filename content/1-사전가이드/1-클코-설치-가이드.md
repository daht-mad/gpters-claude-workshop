# 1편. Claude Code 설치 가이드

> **소요 시간**: 약 30분
>
> 본인 컴퓨터가 **Mac**인지 **Windows**인지 확인 후, 해당 섹션만 따라하세요.
>
> 워크숍 사전과제 **3편 중 1편** — 여기는 직접 따라하면서 설치까지 완료해주세요.
...
설치가 완료됐다면 다음 두 가지를 더 읽어주세요:

- **2편. 워크숍 스킬 안내** — 당일에 함께 써볼 `워크숍 준비 스킬`이 어떤 도구인지 미리 살펴봅니다 (읽기만 OK)
- **3편. VS Code 기본 사용법** — VS Code가 처음이신 분을 위한 핵심 조작법
